...
class Autoencoder_Linear128_2layers_1layer(BaseAutoEncoder):

    def __init__(self):
        super(Autoencoder_Linear128_2layers_1layer, self).__init__()
    ...
    def load_weights(self, filepath):
        ...
        super(Autoencoder_Linear128_2layers_1layer, self).load_weights(filepath)
