...
class Autoencoder_Convolutional_128F_5K(BaseAutoEncoder):

    def __init__(self):
        super(Autoencoder_Convolutional_128F_5K, self).__init__()
    ...
    def load_weights(self, filepath):
        ...
        super(Autoencoder_Convolutional_128F_5K, self).load_weights(filepath)
