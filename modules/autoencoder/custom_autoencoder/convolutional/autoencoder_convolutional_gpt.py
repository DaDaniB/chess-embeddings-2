...
class Autoencoder_Convolutional_GPT(BaseAutoEncoder):
    def __init__(self):
        super(Autoencoder_Convolutional_GPT, self).__init__()
    ...
    def load_weights(self, filepath):
        ...
        super(Autoencoder_Convolutional_GPT, self).load_weights(filepath)
