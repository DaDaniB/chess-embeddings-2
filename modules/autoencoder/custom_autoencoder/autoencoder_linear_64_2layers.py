...
class Autoencoder_Linear64_2layers(BaseAutoEncoder):

    def __init__(self):
        super(Autoencoder_Linear64_2layers, self).__init__()
    ...
    def load_weights(self, filepath):
        ...
        super(Autoencoder_Linear64_2layers, self).load_weights(filepath)
