...
class Autoencoder_Linear128_3layers(BaseAutoEncoder):

    def __init__(self):
        super(Autoencoder_Linear128_3layers, self).__init__()
    ...
    def load_weights(self, filepath):
        ...
        super(Autoencoder_Linear128_3layers, self).load_weights(filepath)
