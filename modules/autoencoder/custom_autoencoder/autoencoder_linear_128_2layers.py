...
class Autoencoder_Linear128_2layers(BaseAutoEncoder):

    def __init__(self):
        super(Autoencoder_Linear128_2layers, self).__init__()
        ...
        self.decoder = tf.keras.Sequential(
            [layers.Dense(LATENT_DIM), layers.Dense(INPUT_SIZE, activation="relu")]
        )
    ...
    def load_weights(self, filepath):
        ...
        super(Autoencoder_Linear128_2layers, self).load_weights(filepath)
