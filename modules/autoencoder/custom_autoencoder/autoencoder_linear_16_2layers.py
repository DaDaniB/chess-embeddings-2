...
class Autoencoder_Linear16_2layers(BaseAutoEncoder):

    def __init__(self):
        super(Autoencoder_Linear16_2layers, self).__init__()
    ...
    def load_weights(self, filepath):
        ...
        super(Autoencoder_Linear16_2layers, self).load_weights(filepath)
