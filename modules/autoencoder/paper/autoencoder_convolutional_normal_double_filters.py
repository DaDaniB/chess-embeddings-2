...
class Autoencoder_Convolutional_normal_double_filters(BaseAutoEncoder):
    def __init__(self):
        super(Autoencoder_Convolutional_normal_double_filters, self).__init__()
    ...
    def load_weights(self, filepath):
        ...
        super(Autoencoder_Convolutional_normal_double_filters, self).load_weights(filepath)
