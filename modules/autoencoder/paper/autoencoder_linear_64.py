...
class Autoencoder_Linear64(BaseAutoEncoder):

    def __init__(self):
        super(Autoencoder_Linear64, self).__init__()
    ...
    def load_weights(self, filepath):
        ...
        super(Autoencoder_Linear64, self).load_weights(filepath)

    def load_default_weights(self):
        self.load_weights("./models/Autoencoder_Linear64nPositions3000000.h5")
