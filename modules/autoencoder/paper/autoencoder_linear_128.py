...
class Autoencoder_Linear128(BaseAutoEncoder):

    def __init__(self):
        super(Autoencoder_Linear128, self).__init__()
    ...
    def load_default_weights(self):
        self.load_weights("./models/Autoencoder_Linear128nPositions3000000.h5")
